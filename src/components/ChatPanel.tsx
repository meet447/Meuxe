...
export function ChatPanel({
  ...
  // ⚡ Bolt: Memoizing the O(N) array iteration for hasRunningTool.
  // Reduces unnecessary recalculations during rapid streaming text updates.
  ...
  // ⚡ Bolt: Wrapped the timeline array mapping in useMemo.
  // This prevents O(N) re-renders of the entire message history
  // on every single token received during streaming text generation,
